...
CREATE TABLE `sys_org` (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='组织机构';

/*Data for the table `sys_org` */

insert  into `sys_org`(`id`,`name`,`address`,`code`,`icon`,`pid`,`is_leaf`,`seq`,`del_flag`,`update_time`,`create_time`) values (26,'百度','','','',NULL,1,0,0,'2017-01-06 12:37:12','2017-01-06 12:37:12'),(27,'事业部','','','',26,1,0,0,'2017-01-06 12:38:56','2017-01-06 12:37:26'),(28,'开发部','','','',27,0,0,0,'2017-01-06 12:37:37','2017-01-06 12:37:37'),(29,'产品部','','','',27,0,1,1,'2017-01-06 12:37:50','2017-01-06 12:37:50'),(30,'售后部','','','',26,0,1,0,'2017-01-06 12:38:12','2017-01-06 12:38:12'),(31,'产品部','','','',27,0,1,1,'2017-01-06 12:41:17','2017-01-06 12:41:17'),(32,'产品部','','','',27,0,1,1,'2017-01-06 12:42:38','2017-01-06 12:42:38'),(33,'产品部','','','',27,0,1,1,'2017-01-06 12:45:32','2017-01-06 12:45:32'),(34,'系统','','','',NULL,0,0,0,'2017-04-18 17:53:44','2017-01-06 12:55:39');
...
insert  into `sys_resource`(`id`,`name`,`url`,`open_mode`,`description`,`icon`,`pid`,`seq`,`status`,`resource_type`,`is_leaf`,`del_flag`,`update_time`,`create_time`) values (236,'系统管理','','0','','icon-standard-male',NULL,1,0,0,1,0,'2017-04-19 17:18:01','2017-01-08 03:33:16'),(237,'机构管理','','0','','icon-standard-group',236,0,0,0,1,0,'2017-04-19 18:59:41','2017-01-08 03:33:32'),(238,'权限管理','','0','','icon-standard-package-add',236,1,0,0,1,0,'2017-04-19 19:03:54','2017-01-08 03:38:43'),(239,'机构列表','/sys/orgs/ui/list','0','','icon-standard-vcard',237,0,0,0,1,0,'2017-04-19 19:00:35','2017-01-08 03:38:56'),(240,'用户列表','/sys/users/ui/list','0','','icon-standard-user',237,0,0,0,0,0,'2017-04-19 19:01:20','2017-01-08 03:39:08'),(242,'列表','','0','','',239,0,0,1,0,0,'2017-01-10 16:23:51','2017-01-08 10:22:24'),(244,'增加','','0','','',239,1,0,1,0,0,'2017-01-08 10:23:19','2017-01-08 10:23:19'),(245,'资源列表','/sys/resources/ui/list','0','','icon-standard-application-view-columns',238,0,0,0,0,0,'2017-04-19 20:42:51','2017-01-10 21:15:22'),(246,'角色列表','/sys/roles/ui/list','0','','icon-standard-user-gray',238,0,0,0,0,0,'2017-04-19 20:43:31','2017-01-10 21:16:15'),(247,'直播管理','','0','','icon-standard-rosette',NULL,0,0,0,1,0,'2017-04-19 18:50:53','2017-01-10 21:20:31'),(248,'直播会员','','0','','',247,0,0,0,1,0,'2017-02-08 21:02:38','2017-01-10 21:20:48'),(249,'用户管理','/live/users/ui/list','0','','',248,0,0,0,0,0,'2017-02-08 21:03:43','2017-01-10 21:21:00');
...
insert  into `sys_role`(`id`,`name`,`seq`,`description`,`status`,`del_flag`,`update_time`,`create_time`) values (11,'系统管理员',0,'',0,0,'2017-01-08 17:30:37','2017-01-08 17:30:37'),(14,'普通员工',1,'',0,0,'2017-01-09 10:52:18','2017-01-09 10:52:18');
...
CREATE TABLE `sys_role_resource` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=603 DEFAULT CHARSET=utf8 COMMENT='角色-资源';

/*Data for the table `sys_role_resource` */

insert  into `sys_role_resource`(`id`,`role_id`,`resource_id`) values (564,11,236),(565,11,237),(566,11,239),(567,11,242),(568,11,244),(569,11,240),(570,11,238),(571,11,245),(572,11,246),(573,11,247),(574,11,248),(575,11,249),(600,14,247),(601,14,248),(602,14,249);
