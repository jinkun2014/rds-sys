...
public interface SysRoleService {
     ...
     */
    BaseResult saveOrUpdate(SysRoleForm form);
     ...
     * Autor: Created by JinKun on 2016-12-30.
     */
    BaseResult update(SysRoleForm form);
     ...
     * Autor: Created by JinKun on 2016-12-30.
     */
    BaseResult list(SysRoleForm form);
     ...
     * Autor: Created by JinKun on 2016-12-30.
     */
    EUDataGridResult listPage(SysRoleForm form);

    BaseResult getResources(Long id);

    BaseResult saveResources(Long roleId, String ids);
}